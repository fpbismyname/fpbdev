...
<section id="pricing" class="relative py-12 md:py-16 lg:py-24 scroll-mt-24">
    <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col gap-8">
            <div class="max-w-2xl mx-auto text-center">
                ...
                <p class="text-base sm:text-lg mb-8 text-base-content/75" data-reveal data-reveal-delay="160">
