...
<section id="hero" class="relative py-24 overflow-hidden bg-linear-to-t from-primary/45 from-0% to-75% to-transparent">
    <div class="container mx-auto max-w-7xl px-4">
        <div class="grid items-center gap-16 mb-16">
            <div class="flex flex-col items-center text-center max-w-4xl mx-auto">
                ...
                <h1 class="text-5xl lg:text-7xl font-black tracking-wide mb-4" data-reveal data-reveal-delay="80">{{ $site_content['headline'] }}</h1>
                <p class="text-lg mb-8 text-base-content/75" data-reveal data-reveal-delay="160">{{ $site_content['subheadline'] }}</p>
                <div class="flex flex-wrap justify-center gap-4" data-reveal data-reveal-delay="240">
