...
<section id="features" class="relative py-24 scroll-mt-24">
    <div class="container mx-auto max-w-7xl px-4">
        <div class="grid gap-8 items-center">
            <div data-reveal-group class="max-w-2xl mx-auto text-center">
                <x-badge value="{{ $site_content['badge'] }}" class="badge-section" data-reveal />
                <h2 class="text-4xl lg:text-5xl font-black tracking-wide mb-4" data-reveal>{{ $site_content['headline'] }}</h2>
